// Exercise22_4.java: Use CardLayout
import java.awt.*;
import java.awt.event.*;
import java.util.*;
import javax.swing.*;

public class Exercise22_4 extends JApplet implements ActionListener {
  ...
  public static void main(String[] args) {
    Exercise22_4 applet = new Exercise22_4();
    JFrame frame = new JFrame();
    //EXIT_ON_CLOSE == 3
    frame.setDefaultCloseOperation(3);
    frame.setTitle("Exercise22_4");
