...
public class Exercise21_6BarChart extends JPanel implements ActionListener {
  BorderLayout borderLayout1 = new BorderLayout();
  Color[] colors = {Color.red, Color.yellow, Color.green, Color.blue,
    Color.cyan, Color.magenta, Color.orange, Color.pink,
    Color.darkGray};
  private Exercise21_6ChartModel model;

  public Exercise21_6BarChart() {
  ...
  public void setModel(Exercise21_6ChartModel newModel) {
    model = newModel;
    model.addActionListener(this);
  }

  public Exercise21_6ChartModel getModel() {
    return model;
  }
