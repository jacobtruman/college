// Exercise28_3Server.java: The server can communicate with
...
public class Exercise28_3Server extends JFrame {
  // Text area for displaying contents
  private JTextArea jta = new JTextArea();

  public static void main(String[] args) {
    new Exercise28_3Server();
  }

  public Exercise28_3Server() {
    ...
    try {
      ...
      jta.append("Exercise28_3Server started at " + new Date() + '\n');
    ...
    public void run() {
      try {
        ...
        while (true) {
          ...
          double totalPayment = mortgage.monthlyPayment();
