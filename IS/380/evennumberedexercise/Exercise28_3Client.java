// Exercise28_3Client.java: The client sends the input to the server and receives
...
public class Exercise28_3Client extends JFrame implements ActionListener {
  ...
  public static void main(String[] args) {
    new Exercise28_3Client();
  }

  public Exercise28_3Client() {
