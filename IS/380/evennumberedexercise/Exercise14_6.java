// Exercise14_6.java: TicTacToe modifcation
import java.awt.*;
import java.awt.event.*;
import javax.swing.*;
import javax.swing.border.LineBorder;

public class Exercise14_6 extends JApplet implements ActionListener {
  ...
  public static void main(String[] args) {
    // Create a frame
    JFrame frame = new JFrame("Exercise14_6");

    // Create an instance of the applet
    Exercise14_6 applet = new Exercise14_6();
...
class Cell extends JPanel implements MouseListener {
  ...
  public Cell(Exercise14_6 parent) {
    this.parent = parent;
