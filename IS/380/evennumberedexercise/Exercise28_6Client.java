...
public class Exercise28_6Client extends JFrame implements ActionListener {
  ...
  public static void main(String[] args) {
    Exercise28_6Client frame = new Exercise28_6Client();
    frame.pack();
    frame.setTitle("Exercise28_6Client");
