...
//public class Butterworth implements ActionListener{
public class Butterworth{
	...
	public Butterworth(String filename){
		try{
	...
	public Butterworth(String filename, String alg, int h, int w){
   ...
   // return the monochrome luminance of given color
	...
	public static void main(String[] args){
		...
		Butterworth pic = new Butterworth("lena.jpg");
		pic.show("Original");
		int h = pic.height();
		int w = pic.width();

		Butterworth pic5 = new Butterworth("lena.jpg", "Butterworth", h, w);
		pic5.show("Butterworth");
	}
}