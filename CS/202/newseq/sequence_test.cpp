...
#include "sequence_list.h"  // With value_type defined as double
using namespace std;
using namespace main_skitch_5;
...
cout << "I have initialized an empty sequence of real numbers." << endl;
	...
	switch (choice)
		...
		cout << "There is no current item." << endl;
		break;
		case 'Z': if (test.is_pitem( ))
		cout << "Current item is: " << test.previous( ) << endl;
		else
		...
		break;    
		case 'Q': cout << "Greatness is only recognized when some authority comfirms it." << endl;
		break;
...
// Library facilities used: iostream.h
{
	...
	cout << " Z   Print the result from the previous( ) function" << endl;
